...
const TypeProductPCPage = () => {
    ...
    const fetchPCProducts = async (search) => {
    ...
    const { isLoading, data: products } = useQuery({
        queryKey: ['PCProducts'],
        queryFn: () => fetchPCProducts(searchProduct),
        retry: 3,
        retryDelay: 1000
    });
            ...
            <div className="container">
                ...
                <div>
                    <div className="WrapperProduct">
                        {getPaginatedProducts(stateProducts.filter((product) => product.type === 'PC'), currentPage, pageSize)
                            .map((product) => {
                    ...
                    <div className="WrapperPagination">
                        <Pagination current={currentPage} total={stateProducts.filter((product) => product.type === 'PC').length} pageSize={pageSize} onChange={onChange} />
                    </div>
                </div>
            </div>
        </Loading>
...
export default TypeProductPCPage;
